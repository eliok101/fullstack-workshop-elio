...
- I can repeat this with notes: (learner to complete)
- I can explain it without the reference code: (learner to complete)
- I can diagnose one failure in this area: (learner to complete)
- Confidence from 1–5: (learner to complete)
